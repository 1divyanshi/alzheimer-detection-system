...
export class Backend implements backendInterface {
    ...
    async deleteScan(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getAllScans(): Promise<Array<ScanRecord>> {
        if (this.processError) {
            try {
    ...
    async getUserScans(): Promise<Array<ScanRecord>> {
        if (this.processError) {
            try {
                const result = await this.actor.getUserScans();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitScan(arg0: string): Promise<ScanRecord> {
        if (this.processError) {
            try {
